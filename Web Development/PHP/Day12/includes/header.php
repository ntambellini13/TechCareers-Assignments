           ...
           <div class="container header" id="headerDiv">
             <header id="testID">
                 ...
                 <nav class="navbar navbar-expand-lg navbar-dark container-fluid">
                  ...
                  <!-- Display logged in or logged out message -->
                  <?php 
                      require "includes/validateLogin.php";
                      if (isset($_SESSION['is_logged_in'])){
                        echo '<p class="headertext">You are logged in.</p>';
                      } else {
                        echo '<p class="headertext">You are not logged in.</p>';
                      }
                  ?>
                   ...
                   <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                     <ul class="navbar-nav ml-auto">
                       <li class="nav-item">
                       <?php 
                       //Change based on whether user is logged in or out
                          if (isset($_SESSION['is_logged_in'])){
                            echo '<a class="nav-link" href="logout.php"</a><i class="fas fa-sign-out-alt"></i>Logout</a>';
                          } else {
                            echo '<a class="nav-link" href="login.php"</a><i class="fas fa-sign-in-alt"></i>Login</a>';
                          }
                      ?>
                       </li> 
                       <li class="nav-item">
                       ...
                       <li class="nav-item">
                          <a class="nav-link" href="newAgent.php"</a><i class="fas fa-user-secret"></i>Agent</a>
                       </li>
                     </ul>
                   </div>
                 </nav>
