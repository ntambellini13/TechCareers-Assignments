...
// popup message indicating required data for registration form when clicked
...
// remove message indicating required data for registration form when clicked
...
function searchForEmpty(){
  ...
  // To check empty form fields.
   ...
   {
      var currentInputValue = regForm[item]; 
      //assign next value into a variable for processing; causes errors if not.
...
var imageArr = ["images/js_image/img-2.jpg","images/js_image/img-3.jpg","images/js_image/img-1.jpg","images/js_image/img-4.jpg","images/js_image/img-7.jpg","images/js_image/img-6.jpg","images/js_image/img-5.jpg"];
var descArray = ["Bali, Indonesia", "Bangkok, Thailand","Barcelona, Spain", "Beijing, China","Sao Paulo, Brazil","Tofino, Canada","Zanzibar, Tanzania"];
var urlArray = ["https://www.lonelyplanet.com/indonesia/bali", "https://www.lonelyplanet.com/thailand/bangkok", "https://www.lonelyplanet.com/spain/barcelona", "https://www.lonelyplanet.com/china/beijing","https://www.lonelyplanet.com/brazil/sao-paulo","https://www.lonelyplanet.com/canada/british-columbia/tofino-and-around","https://www.lonelyplanet.com/tanzania/zanzibar-island"];
...
//make the table dynamically on page load
...
//image appears when hovering over the location
...
//image dissapears when another location is hovered over
function imageDisappear ()
{
   var newDiv = document.getElementById("imgDiv");
}

//open a new window with link when image or location is clicked on
