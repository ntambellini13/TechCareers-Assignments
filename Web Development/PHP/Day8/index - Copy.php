...
<!DOCTYPE html>
    ...
    <head>
              ...
              <header id="testID">
                  ...
                  <nav class="navbar navbar-expand-lg navbar-dark container-fluid">
                    ...
                    <a class="navbar-brand" href="index.php">
                      <img class="main-logo mr-auto" src="images\travel\3d-illustration-land-and-a-group-of-suitcases-to-1412103-640x480-Travel-logo.jpg" width="30" height="30" class="d-inline-block align-top img-responsive" alt="">  
      ...
      <section>
        <table id="descTable" class="testImg table table-dark table-striped col-3 ml-3">
        <th scope="col"><h3>Places To Visit</h3></th>
        </table>
        <div id="imgDiv"></div>

        <div id="wrapper" class="img-responsive">
            <div id="ball" class="img-responsive"></div>
            <img id="ball" class="img-responsive" src="images\travel\globe1.jpg"></img>
        </div>
      </section>
            <!-- Copyright -->
        <footer class="copyright col-"><p>Made by Owiny and Nico <i class="far fa-copyright"></i> 2019</p></footer>
