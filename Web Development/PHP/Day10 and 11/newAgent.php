    ...
    <section>
        <form class="reg-form mx-auto" name="agentForm" id="inputForm" method="POST" action="">
            ...
            <div class="mb-2 button-toolbar">
                <button type="submit" id="submitButton" value="Submit" name="submitButton" class="btn btn-primary">Submit</button>
                ...
                <button type="reset"  id="resetButton" value="Reset" class="btn btn-danger">Reset</button>
            </div> 
